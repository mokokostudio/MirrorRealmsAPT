...
namespace ET.Client
{
    [EntitySystemOf(typeof (MrOperaComponent))]
    [FriendOf(typeof (MrOperaComponent))]
    [FriendOfAttribute(typeof (MrArmWeaponComponent))]
    public static partial class MrOperaComponentSystem
    {
        [EntitySystem]
        private static void Awake(this MrOperaComponent self)
        {
            self.mapMask = LayerMask.GetMask("Map");
        }

        [EntitySystem]
        private static void Update(this MrOperaComponent self)
        {
            self.UpdateMovement();
        ...
        private static void UpdateCamera(this MrOperaComponent self)
        {
        ...
        private static void UpdateMovement(this MrOperaComponent self)
        {
        ...
        private static void UpdateSkill(this MrOperaComponent self)
        {
        ...
        private static void ChangeWeapon(this MrOperaComponent self)
        {
            var myUnit = MrUnitHelper.GetMyUnitFromCurrentScene(self.Scene());
            var armWeaponMode = myUnit.GetComponent<MrArmWeaponComponent>().Mode;
            ...
            clientInventoryItems.AddRange(myUnit.GetComponent<ClientInventoryComponent>().Children
                    ...
                    .Where(v => v.ItemType == MrInventoryType.Weapon));
        ...
        private static void CastCast(this MrOperaComponent self, int skillId)
        {
            ClientCastHelper.CastCast(self.Root(), skillId).Coroutine();
        }

        private static void CastSkill(this MrOperaComponent self, string skillName)
        {
            ClientCastHelper.CastSkill(self.Root(), skillName).Coroutine();
        }

        private static void CastAttakSkill(this MrOperaComponent self)
        {
            var myUnit = MrUnitHelper.GetMyUnitFromCurrentScene(self.Scene());
            if (myUnit == null)
            {
        ...
        private static void CastWeaponSkill(this MrOperaComponent self, int index)
        {
            var myUnit = MrUnitHelper.GetMyUnitFromCurrentScene(self.Scene());
            if (myUnit == null)
            {
        ...
        private static void CastSlideSkill(this MrOperaComponent self)
        {
            var myUnit = MrUnitHelper.GetMyUnitFromCurrentScene(self.Scene());
            if (myUnit == null)
            {
