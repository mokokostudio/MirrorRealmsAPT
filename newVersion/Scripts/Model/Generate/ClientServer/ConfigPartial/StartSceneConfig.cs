...
namespace ET
{
    public partial class StartSceneConfigCategory
    {
        ...
        public StartSceneConfig MrLobby;

        public List<StartSceneConfig> MrRoomRoots = new();
            ...
            foreach (StartSceneConfig startSceneConfig in this.GetAll().Values)
            {
                ...
                switch (startSceneConfig.Type)
                {
                    ...
                    case SceneType.BenchmarkServer:
                        ...
                        break;
                    case SceneType.MrLobby:
                        this.MrLobby = startSceneConfig;
                        break;
                    case SceneType.MrRoomRoot:
                        this.MrRoomRoots.Add(startSceneConfig);
                        break;
                }
            }
        }
