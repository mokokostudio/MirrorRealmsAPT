...
// using
	...
	[ResponseType(nameof(MrLobby2R_GetLoginKey))]
	[Message(InnerMessage.MrR2Lobby_GetLoginKey)]
	[MemoryPackable]
	public partial class MrR2Lobby_GetLoginKey: MessageObject, IRequest
	{
		public static MrR2Lobby_GetLoginKey Create(bool isFromPool = true) 
		{ 
			return ObjectPool.Instance.Fetch(typeof(MrR2Lobby_GetLoginKey), isFromPool) as MrR2Lobby_GetLoginKey; 
		}
	...
	[Message(InnerMessage.MrLobby2R_GetLoginKey)]
	[MemoryPackable]
	public partial class MrLobby2R_GetLoginKey: MessageObject, IResponse
	{
		public static MrLobby2R_GetLoginKey Create(bool isFromPool = true) 
		{ 
			return ObjectPool.Instance.Fetch(typeof(MrLobby2R_GetLoginKey), isFromPool) as MrLobby2R_GetLoginKey; 
		}
	...
	[ResponseType(nameof(MrRoomRoot2Lobby_CreateRoom))]
	[Message(InnerMessage.MrLobby2RoomRoot_CreateRoom)]
	[MemoryPackable]
	public partial class MrLobby2RoomRoot_CreateRoom: MessageObject, IRequest
	{
		public static MrLobby2RoomRoot_CreateRoom Create(bool isFromPool = true) 
		{ 
			return ObjectPool.Instance.Fetch(typeof(MrLobby2RoomRoot_CreateRoom), isFromPool) as MrLobby2RoomRoot_CreateRoom; 
		}
	...
	[Message(InnerMessage.MrRoomRoot2Lobby_CreateRoom)]
	[MemoryPackable]
	public partial class MrRoomRoot2Lobby_CreateRoom: MessageObject, IResponse
	{
		public static MrRoomRoot2Lobby_CreateRoom Create(bool isFromPool = true) 
		{ 
			return ObjectPool.Instance.Fetch(typeof(MrRoomRoot2Lobby_CreateRoom), isFromPool) as MrRoomRoot2Lobby_CreateRoom; 
		}
...
// 房间的ActorId
	...
	[ResponseType(nameof(MrMap2RoomRoot_Init))]
	[Message(InnerMessage.MrRoomRoot2Map_Init)]
	[MemoryPackable]
	public partial class MrRoomRoot2Map_Init: MessageObject, IRequest
	{
		public static MrRoomRoot2Map_Init Create(bool isFromPool = true) 
		{ 
			return ObjectPool.Instance.Fetch(typeof(MrRoomRoot2Map_Init), isFromPool) as MrRoomRoot2Map_Init; 
		}
	...
	[Message(InnerMessage.MrMap2RoomRoot_Init)]
	[MemoryPackable]
	public partial class MrMap2RoomRoot_Init: MessageObject, IResponse
	{
		public static MrMap2RoomRoot_Init Create(bool isFromPool = true) 
		{ 
			return ObjectPool.Instance.Fetch(typeof(MrMap2RoomRoot_Init), isFromPool) as MrMap2RoomRoot_Init; 
		}
	...
	public static class InnerMessage
	{
		 ...
		 public const ushort MrR2Lobby_GetLoginKey = 20025;
		 public const ushort MrLobby2R_GetLoginKey = 20026;
		 public const ushort MrLobby2RoomRoot_CreateRoom = 20027;
		 public const ushort MrRoomRoot2Lobby_CreateRoom = 20028;
		 public const ushort MrRoomRoot2Map_Init = 20029;
		 public const ushort MrMap2RoomRoot_Init = 20030;
	}
}
