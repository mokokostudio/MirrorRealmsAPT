...
namespace ET.Client
{
    [EntitySystemOf(typeof(MrRouterCheckComponent))]
    public static partial class MrRouterCheckComponentSystem
    {
        [EntitySystem]
        private static void Awake(this MrRouterCheckComponent self)
        {
            self.CheckAsync().Coroutine();
        }

        private static async ETTask CheckAsync(this MrRouterCheckComponent self)
        {
