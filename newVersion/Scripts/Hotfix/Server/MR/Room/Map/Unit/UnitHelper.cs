...
namespace ET.Server
{
    ...
    public static partial class UnitHelper
    {
        public static UnitInfo CreateUnitInfo(Unit unit, bool isMyUnit)
        {
            ...
            var playerInfo = unit.GetComponent<MrPlayerInfo>();
            if (playerInfo != null)
            {
                unitInfo.PlayerInfo = new() { PlayerName = playerInfo.Name, ArmWeaponMode = (uint)unit.GetComponent<MrArmWeaponComponent>().Mode, };
