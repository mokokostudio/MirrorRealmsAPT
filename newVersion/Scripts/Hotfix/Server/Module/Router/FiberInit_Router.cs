...
namespace ET.Server
{
    ...
    public class FiberInit_Router: AInvokeHandler<FiberInit, ETTask>
    {
        public override async ETTask Handle(FiberInit fiberInit)
        {
            ...
            // Host模式用这个
            //root.AddComponent<RouterComponent, IPEndPoint, string>(NetworkHelper.ToIPEndPoint($"0.0.0.0:{startSceneConfig.Port}"), startSceneConfig.StartProcessConfig.InnerIP);
