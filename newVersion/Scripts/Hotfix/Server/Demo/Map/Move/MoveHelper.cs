...
//     {
//         public static async ETTask MoveToAsync(this Unit unit, float3 target)
//         {
...
//             // }
//             //
//             // float3 endPos = unit.GetComponent<PathfindingComponent>().FindNearestWallHitPoint(unit.Position, target);
//             //
//             // M2C_PathfindingResult m2CPathfindingResult = new();
//             // m2CPathfindingResult.Id = unit.Id;
//             // m2CPathfindingResult.Points.Add(unit.Position);
//             // m2CPathfindingResult.Points.Add(endPos);
//             //
...
//         }
//
//         public static void StopMovement(this Unit unit, int error)
//         {
//             var m = unit.GetComponent<MoveComponent>();
//             if (m == null)
//             {
//                 return;
//             }
