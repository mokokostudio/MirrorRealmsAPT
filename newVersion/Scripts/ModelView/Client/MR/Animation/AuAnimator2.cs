...
namespace ET.Client
{
    public class AuAnimator2
    {
        ...
        public void PlayAnim(CharacterAnimationDataClip.CustomAnim[] anims, bool blendMove)
        {
            if (blendMove)
            {
                if (m_State != State.Move)
        ...
        private Playable CreateAnimPB(CharacterAnimationDataClip.CustomAnim[] anims, Action finishCall)
        {
