...
namespace ET.Client
{
    public class AuAnimator
    {
        ...
        public void PlaySingle(CharacterAnimationDataClip.CustomAnim[] anims)
        {
        ...
        public void PlaySingleWithMove(CharacterAnimationDataClip.CustomAnim[] anims)
        {
        ...
        private class BlendMovePB: PlayableBehaviour
        {
            ...
            public static Playable Create(PlayableGraph graph, AnimationClip[] clips, float[] moveDistance, Func<float> speedGet,
            Func<float> blendGet)
            {
        ...
        {
            private CharacterAnimationDataClip.CustomAnim[] m_Anims;
            private AnimationMixerPlayable m_Mixer;
            private AnimationClipPlayable[] m_Clips;

            public static Playable Create(PlayableGraph graph, CharacterAnimationDataClip.CustomAnim[] anims)
            {
